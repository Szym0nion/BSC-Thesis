...
\newcommand{\SlowaKluczowe}{Czas reakcji, Saturacja krwi, Fala tętna, Układ pomiarowy, Grupy pacjentów, Monitorowanie parametrów zdrowonych, Adaptacyjne układu krążenia, Wysiłek fizyczny, Ekstremalne warunki atmosferyczne, Medycyna sportowa, Rehabilitacja, Analiza wyników badań, Indywidualne potrzeby pacjentów, Badania interdyscyplinarne\newline}
...
\begin{document}
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %\DolaczRozdzial{DodatekA}
    %\DolaczRozdzial{DodatekAplikacje}
    %\DolaczRozdzial{DodatekZalaczniki}
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
